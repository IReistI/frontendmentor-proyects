...
export function Units() {
  ...
  return (
    <div className='relative z-50'>
      <button onClick={() => setIsOpen(!isOpen)} className='flex gap-2 px-2.5 py-2 bg-neutral-800 rounded-md md:rounded-lg md:px-4 md:py-3 hover:bg-neutral-700 cursor-pointer' aria-expanded="false" aria-haspopup="menu">
